...
import Effectful.Dispatch.Dynamic (localSeqLend, localSeqLift, localSeqUnlift, reinterpret)
...
runGhciSessionIO = reinterpret (evalState (Nothing :: Maybe Ghcid.Ghci)) $ \env -> \case
