...
-- Example:
--
-- >>> newtype Test = Test Text deriving stock (Show) deriving newtype (FromJSON)
-- >>> instance Default Test where def = Test "default"
-- >>> let cfg = LoadedConfig $ Aeson.Object (KM.singleton "foo" (Aeson.Object (KM.singleton "bar" (Aeson.String "test"))))
-- >>> extractNestedConfig @"foo.bar" @Test cfg
-- Test "test"
