{
  pkgs = hackage: {
    packages = {
      ...
      appear.revision = import ./cabal-files/appear.nix;
      ...
      mlkem.revision = import ./cabal-files/mlkem.nix;
      mlkem.flags.use_crypton = true;
    ...
    (
      { lib, ... }:
      {
        packages = {
          ...
          "mlkem".components.library.planned = lib.mkOverride 900 true;
          ...
          "appear".components.library.planned = lib.mkOverride 900 true;
